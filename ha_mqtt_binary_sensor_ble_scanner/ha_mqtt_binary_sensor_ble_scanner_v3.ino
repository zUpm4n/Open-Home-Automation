  ...
  public BLEAdvertisedDeviceCallbacks {
    void onResult(BLEAdvertisedDevice advertisedDevice) {
      ...
      if (!findedAdvertisedDevice) {
        ...
        BLETrackedDevices[NB_OF_BLE_DISCOVERED_DEVICES - 1].address = advertisedDevice.getAddress().toString().c_str();
        ...
        String tmp_string_ble_address = advertisedDevice.getAddress().toString().c_str();
